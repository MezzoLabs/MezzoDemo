...
use App\Magazine\Shop\Domain\Models\HasSubscriptions;
...
{
    use Authenticatable, CanResetPassword, Authorizable, HasPermissions, HasShoppingBasket, HasSubscriptions;
