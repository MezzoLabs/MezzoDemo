...
use App\Magazine\Shop\Http\Pages\Voucher\CreateVoucherPage;
use App\Magazine\Shop\Http\Pages\Voucher\EditVoucherPage;
use App\Magazine\Shop\Http\Pages\Voucher\IndexVoucherPage;
...
class VoucherController extends CockpitResourceController
{
    ...
    {
        return $this->page(IndexVoucherPage::class);
    }
    ...
    {
        return $this->page(CreateVoucherPage::class);
    }
    ...
    {
        return $this->page(EditVoucherPage::class);
    }
}